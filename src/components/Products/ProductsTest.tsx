                ...
                <div className="space-y-10 [&_p]:text-base [&_li]:text-base">
                    ...
                    <header className="space-y-4 text-center @xl:text-left">
                        ...
                        <p className="text-lg leading-relaxed">
                            Two layers make this work. The capabilities – analytics, replay, flags, logs, experiments,
                            and more – give agents the context to see what's working and act on it. The surfaces –
                            Slack, PostHog Code, the MCP, and the web app – are how you reach those agents. Together,
                            they make your product self-driving.
                        </p>
