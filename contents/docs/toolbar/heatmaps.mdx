...
You can view heatmaps via the PostHog toolbar, the in-app Heatmap tool (currently an opt-in beta), or ask [PostHog AI to analyze your heatmaps](/docs/web-analytics/analyze-heatmaps-ai) and recommend changes.
