...
Logs are retained for 14 days by default. Paid plans offer extended retention:

| Retention | Availability |
|-----------|--------------|
| 14 days | All plans (default) |
| 30 days | Paid plans |
| 90 days | Paid plans |

Extended retention is priced separately from ingestion and billed per GB stored. Change your retention setting in [**Settings** > **Environment** > **Logs**](https://app.posthog.com/settings/environment-logs). Changes only apply to new logs — existing logs keep their original retention period.
