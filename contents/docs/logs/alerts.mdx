...
- **Microsoft Teams** – paste a URL from a Teams "Workflows" (Power Automate) or incoming webhook connector. Notifications are delivered as formatted Adaptive Cards.
