...
Contextual tools available when viewing the [Web Analytics](/docs/web-analytics) page. These activate automatically based on the page you're on, rather than through mode switching.

**Best for:**

- Diagnosing web analytics setup issues like missing pageviews or partial proxy coverage
- Analyzing heatmap data for specific pages
- Understanding where users click, rage-click, and scroll
- Getting recommendations for page improvements based on heatmap signals

**Contextual tools:**

- `web_analytics_doctor` - Diagnose web analytics setup issues
- `assess_heatmap` - Assess click, rageclick, and scroll-depth [heatmap](/docs/toolbar/heatmaps) data for a page URL, identify elements under hotspots by cross-referencing autocapture data, and recommend changes
