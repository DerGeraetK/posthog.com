...
- Finding recordings by what Replay Vision scanners observed in them
...
- `search_replay_vision_observations` - Search Replay Vision observations using natural language
