...
By default, **Enter** sends your message and **Shift+Enter** adds a new line. To use **Enter** for new lines instead, go to [Settings > Customization](https://app.posthog.com/settings/user#ai-chat-send-key) and enable **AI chat send shortcut**. With it on, **Cmd+Enter** (or **Ctrl+Enter** on Windows) sends your message and **Enter** adds a new line. This preference is saved to your account, so it applies across all your devices.
