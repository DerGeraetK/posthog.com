...
Upload dSYM files to symbolicate native iOS crashes. Follow the [iOS dSYMs guide](/docs/error-tracking/upload-source-maps/ios) to set up a build phase script in Xcode that uploads dSYMs automatically.

### Android

If your app uses ProGuard or R8 minification, upload mapping files to deobfuscate native Android stack traces. Follow the [Android mappings guide](/docs/error-tracking/upload-mappings/android) to set up the PostHog Gradle plugin for automatic uploads.
