...
- **Manage rate limits** – View or update project-wide and per-issue exception rate limits to control ingestion costs.
...
- `What are my current error tracking rate limits?`
- `Set the project-wide rate limit to 5000 exceptions per hour.`
