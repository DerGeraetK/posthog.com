...
| Tool | Description |
|------|-------------|
| `execute-sql` | Run a HogQL query against your revenue data, including connected sources like Stripe. Supports MRR calculations, cohort analysis, and custom breakdowns. |
