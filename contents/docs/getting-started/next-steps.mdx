...
Once you've [enabled session replay](/docs/session-replay/installation) in your project, head to the [Filter templates tab](https://us.posthog.com/replay/templates) in session replay to watch how users navigate specific parts of your app.
