...
Task lists use GFM (GitHub Flavored Markdown) syntax. In edit mode, click checkboxes to toggle them. You can also create task items by typing `[ ] ` or `[x] ` at the start of a paragraph or bullet item.
