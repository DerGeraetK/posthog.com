...
- **500-repo cap on the picker.** If your GitHub account has access to more than 500 repos, the list is truncated. Add a routing rule for repos that fall off the end.
