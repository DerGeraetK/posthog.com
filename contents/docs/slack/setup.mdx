...
If you don't have project admin permissions, you'll see a **Request access** form instead of the connect button. Add a short note explaining why your team needs the Slack integration and click **Request Slack** – your project admins will receive an email with a link to connect it.
