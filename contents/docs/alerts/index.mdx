...
Slack notifications include the alert name, insight name, breach details, and a rendered chart image of the insight. This lets you triage alerts at a glance without opening PostHog.
