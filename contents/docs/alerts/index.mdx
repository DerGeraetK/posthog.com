...
3. For Discord notifications:
   - Enter the [incoming webhook URL](https://support.discord.com/hc/en-us/articles/228383668-Intro-to-Webhooks) for the channel where you want alerts sent. You can create one in your Discord server settings under **Integrations** > **Webhooks**. Discord only needs a webhook URL, so there's no integration to connect.
