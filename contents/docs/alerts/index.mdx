...
4. For Microsoft Teams notifications:
   - Enter your Microsoft Teams incoming webhook or Power Automate workflow URL. No integration to connect is required. You can create a webhook in Microsoft Teams by going to your channel, clicking the three dots, selecting **Workflows**, and choosing **Post to a channel when a webhook request is received**. See the [Microsoft Teams destination docs](/docs/cdp/destinations/microsoft-teams) for more details.
