...
Alerts are supported on [trends](/docs/product-analytics/trends), [funnels](/docs/product-analytics/funnels), and [SQL insights](/docs/sql).
...
1. Alerts are based off of [insights](/docs/product-analytics/insights). You can pick any existing trend, funnel, or SQL insight, or create a new one.
...
PostHog AI can create alerts on existing insights or generate new insights and set up alerts on them automatically. To update existing alerts, PostHog AI finds the alert by name and applies your changes.
