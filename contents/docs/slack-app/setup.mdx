...
In Slack Connect (externally-shared) channels, the bot asks for one-time approval before answering. Any org member can click **Allow** to enable the bot in that channel – this prevents data from being exposed to external members without consent.
