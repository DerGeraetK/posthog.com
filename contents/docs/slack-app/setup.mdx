...
To talk to the bot in a channel, @-mention it – Slack will prompt you to invite it – or invite it explicitly with `/invite @PostHog`. When the bot joins a channel for the first time, it posts a welcome message with an overview of what it can do and a few example prompts.
