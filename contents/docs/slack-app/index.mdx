...
- A personal GitHub connection for each teammate who wants PRs authored under their own name, or your team's organization-level GitHub so teammates can author PRs as the PostHog bot instead.
...
Heads up: the resulting PR is authored under whoever started the task – either their personal GitHub integration or the PostHog bot if they chose that option – so a teammate's follow-up edits land under the original requester's attribution. If you want the PR credited to you, start your own task.
