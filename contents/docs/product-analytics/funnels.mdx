...
- **Time to convert** – shows the median time users take to complete each step. Steps with a long time to convert are likely much harder than steps with a short time.
