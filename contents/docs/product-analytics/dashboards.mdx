...
Widget tiles update when you refresh the dashboard. Click the tile title to jump to the full view for that feature (e.g., Activity > Explore for recent events).
