...
The banner includes a **Copy events** button to copy the missing event names and add them in your [Stripe webhook dashboard](https://dashboard.stripe.com/webhooks).
