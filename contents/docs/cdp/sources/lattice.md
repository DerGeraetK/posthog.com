...
4. Back in PostHog, select your **Region** (US or EMEA) to match where your Lattice data is hosted. US uses `api.latticehq.com` and EMEA uses `api.emea.latticehq.com`.
