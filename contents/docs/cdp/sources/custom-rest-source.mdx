...
| **Datetime format**    | strftime pattern for formatting datetime/date cursors when sending to the API (e.g. `%Y-%m-%dT%H:%M:%SZ`). Leave blank for ISO-8601. Only applies to Datetime, Date, and Timestamp cursor types. |
