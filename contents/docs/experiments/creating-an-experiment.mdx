...
Each variant also has a **Notes** field where you can document details like what the variant does or its reroute URL. Click the field to edit inline and save by clicking the check button or clicking away.
