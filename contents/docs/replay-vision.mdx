...
3. Write a prompt describing what the scanner should look for. Be concrete and avoid speculation – e.g. *"Return true if someone appears stuck on a page – scrolling without engaging, hovering over elements with no clear CTA, or abandoning shortly after arriving."* Click **Write with PostHog AI** next to the prompt field if you want help drafting or refining your prompt.
