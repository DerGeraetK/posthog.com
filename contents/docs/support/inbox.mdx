...
Change the status of multiple tickets at once.

1. Select tickets using the checkboxes in the ticket list
2. Click the **Mark as** dropdown above the list
3. Choose the new status

You can select up to 500 tickets per bulk update. The header row checkbox selects or deselects all tickets on the current page.
