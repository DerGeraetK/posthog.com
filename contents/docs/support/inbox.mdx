...
If a widget ticket has a known customer email (collected by the [identification form](/docs/support/widget#identification-form)) and your team has a verified [email channel](/docs/support/email), your replies are also sent to that email address, so customers get your response even after they've left your site. This requires email to be enabled in your Support settings. Widget tickets without a known email are unaffected: replies stay in the widget.
