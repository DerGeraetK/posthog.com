...
<CalloutBox icon="IconInfo" title="Sharing domains across projects" type="fyi">

Multiple projects in the same organization can use the same email domain. When you verify a domain in one project, the verification applies to all projects in your organization using that domain.
