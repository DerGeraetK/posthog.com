> Requires `posthog-react-native` >= [4.36.0](https://github.com/PostHog/posthog-js/releases) and `@posthog/react-native-plugin` >= [1.3.0](https://github.com/PostHog/posthog-react-native-session-replay/releases). On `posthog-react-native` < 4.47.0, install `posthog-react-native-session-replay` instead.
