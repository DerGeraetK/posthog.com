> Requires `posthog-react-native` >= [4.36.0](https://github.com/PostHog/posthog-js/releases) and `@posthog/react-native-plugin` >= [2.0.0](https://github.com/PostHog/posthog-js/releases).
