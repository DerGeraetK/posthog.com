...
| Tool | Description |
|------|-------------|
| `execute-sql` | Run a HogQL query against your web analytics data. Supports pageview counts, bounce rates, session durations, traffic breakdowns, and path analysis. |
