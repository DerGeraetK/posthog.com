...
You can delete feature flags linked to draft or stopped [experiments](/docs/experiments), but not flags linked to running experiments. If you try to delete a flag with a running experiment, PostHog shows a warning asking you to stop the experiment first.

Deleting a flag linked to an experiment preserves the experiment's historical data – including results and exposure counts. This frees up the flag key for reuse without losing your experiment history.
