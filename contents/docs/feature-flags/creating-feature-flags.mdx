...
Without this setting, a beta tester who falls outside the 50% rollout can still match the 10% rollout in condition 2. With it enabled, that beta tester gets `false` immediately after failing the rollout check in condition 1.
