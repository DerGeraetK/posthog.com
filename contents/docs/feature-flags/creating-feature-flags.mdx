...
- If you capture identified events, you can target based on [person properties](/docs/product-analytics/person-properties) and [cohorts](/docs/data/cohorts). Cohort targeting supports both **user in** (include users in the cohort) and **user not in** (exclude users in the cohort) operators, so you can roll out a feature to everyone except a specific group.
