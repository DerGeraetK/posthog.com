...
5. Have ["Stop evaluation at first matching condition set"](/docs/feature-flags/creating-feature-flags#stop-evaluation-at-first-matching-condition-set) (early exit) enabled. The [Python](/docs/libraries/python) SDK fully supports this setting. Other SDKs currently evaluate all condition groups regardless of this setting – support is being added.
